...
"        ber has no exponent, require the output file\n"
"        number to have no exponent and to have the\n"
"        same number of decimal places as the test\n"
"        file number, else it is a Formatting Error.\n"
"\n"
"    +case\n"
"        Differences in letter case are Formatting\n"
...
"        equal.  See below for definitionof relative\n"
