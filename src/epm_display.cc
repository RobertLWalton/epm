...
"        each page.  The body coordinates of the\n"
"        lower left corner of the page are (LLX,LLY),\n"
"        and the body coordinates of the upper right\n"
"        corner are (URX,URY).  If this is not set\n"
"        for a page, the bounds are automatically\n"
"        computed, but this does not always work\n"
"        well.\n"
"\n"
"      scale S\n"
"        Sets the default scale S for each page.\n"
"        This is the ratio of Y length in inches\n"
"        per unit of Y body coordinate to X length\n"
"        in inches per unit of X body coordinate.\n"
"        Frequently S = 1 is desired.\n"
"\n"
