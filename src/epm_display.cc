...
// Date:	Thu Jul  9 00:47:39 EDT 2020
//
...
"    on list for the foot.  After these are read the\n"
...
"    lines.\n"
"\n"
"    For body commands, some coordinate units are in\n"
"    `points' and some are `body coordinates'.  The\n"
"    latter are arbitrary, and are scaled automati-\n"
"    cally so the bounding box of all points with\n"
"    such coordinates, plus some space for margins,\n"
"    fits in the area between the head and foot.\n"
"    The ration of the X and Y scales defaults to 1,\n"
"    but can be set.\n"
"\n"
"    Numbers that represent lengths can have the `pt'\n"
"    suffix meaning `points', the `in' suffix meaning\n"
"    `inches', or no suffix, meaning the number is a\n"
"    body coordinate (and must be associated with\n"
"    the X or Y axis).  Body coordinates are not per-\n"
"    mitted in the head or foot.\n"
"\n"
...
"\n"
"    The commands are described below.  Lower case\n"
"    letters in a command designate parameters.\n"
"    + denotes one or more qualifiers.\n"
"\n"
"    Global Parameter Commands:\n"
"    ------ --------- --------\n"
"\n"
"        SCALE s\n"
"          Y over X scale ratio; defaults to 1.\n"
"\n"
"        MARGIN all\n"
...
"          text may overflow into the these margins.\n"
"          The lengths may not be body coordinates.\n"
"          If multiple MARGIN commands are given,\n"
"          the maximum of all given margins is used.\n"
"          Default is `MARGIN 0.25in'.\n"
"\n"          
...
"          level stack.\n"
"\n"
"        There is an implicit `LEVEL 1' command\n"
...
"    ------- --------- --------\n"
"\n"
"        FONT size [space] [options] [family]\n"
"	    size is the em square size of the font\n"
"                and is normally given in points;\n"
"                e.g., 10pt; defaults:\n"
"                   14pt for head\n"
"                   10pt for other lists\n"
"           space is the extra horizontal space\n"
"                 between text lines; default 2pt\n"
"	    options is some of:\n"
"		B for bold\n"
"		I for italic\n"
"	    family is one of:\n"
...
"           right adjusted.\n"
"\n"
"        These commands an only appear on the head or\n"
"        or foot list.\n"
"\n"
"\n"
"    Body Commands:\n"
...
"\n"
"\n"
"        T [color] [options] x y text\\...\n"
"          Display text at point (x,y) which must\n"
"          be in body coordinates.  Options are:\n"
"            T  display 0.5em below point\n"
"            B  display 0.5em above point\n"
"               If neither option, vertically\n"
"               center on y.\n"
"            L  display 0.5em to left of point\n"
"            R  display 0.5em to right of point\n"
...
"          by backslashes (\\).\n"
"\n"
"        P [color] [options] [start stop] [x y]"
                                        " [width]\n"
"          Begin a path at (x,y) which must be in\n"
"          body coordinates.  Width is the line\n"
"          width (default 1pt), options are as\n"
"          follows:\n"
"            .   dotted line\n"
"            -   dashed line\n"
...
"          and start/stop specify special path ends\n"
"          as follows:\n"
"            N   nothing special\n"
"            A   arrow\n"
"            R   reverse arrow\n"
...
"\n"
"        A xc yc r [g1 g2]\n"
"          Continue path by a circular arc with\n"
"          center (xc,yc), radius r, and if given\n"
"          start point at angle g1 and stop point\n"
"          at angle g2.  g1 and g2 are in degrees\n"
"          and if given must not be equal.  If\n"
"          g1 < g2 the arc goes counter-clock-wise;\n"
"          if g2 < g1 the arc goes clockwise. Any\n"
"          integer multiple of 360 added to g1 or g2\n"
"          does not affect the designated points.\n"
"\n"
"          If g1 and g2 are not given, the arc is a\n"
"          complete circle and must be the ONLY\n"
"          command in its path.\n"
"\n"
"        E xc yc rx ry a [g1 g2]\n"
"          Display elliptical arc drawn as follows.\n"
"          First an elipse is drawn centered at with\n"
"          x,y semi-axises rx, ry.  Then the elipse\n"
"          is rotated by angle `a' (in degrees).\n"
"          Lastly if g1 and g2 are given, they are\n"
"          used as for `A' to identify endpoints of\n"
"          the arc.  As for `A', if g1 and g2 are\n"
"          not given, the arc is a complete ellipse\n"
"          and must be the ONLY command in its path.\n"
"\n"
"    With the -RxC option, multiple pages are put on\n"
"    each physical paper page.  Here R and C are\n"
"    very small integers, and there are R rows of C\n"
"    of logical pages per physical page.\n"
;
