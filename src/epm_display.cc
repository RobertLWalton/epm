...
// Date:	Thu Sep  3 02:56:57 EDT 2020
//
...
"          physical page).\n"
"\n"
"    A logical page is divided into three sections: a\n"
"    head, a body, and a foot, in that order from\n"
"    top to bottom.  (But not necessarily in that\n"
"    order in the input).\n"
"\n"
"    The command lines in a page section are read\n"
"    and saved in lists.  There is one list for the\n"
