...
// Date:	Sun Aug 23 04:17:50 EDT 2020
//
...
"\n"
"    Layout Parameter Commands:\n"
"    ------ --------- --------\n"
"\n"
"      These commands can be given in a layout\n"
"      section.  The `background', `scale', and `margin'
"      commands may be used in a page section to\n"
"      override layout parameters for the page.\n"
...
"      arrow X Y\n"
"        Continue path by straight line to (X,Y)\n"
"        which must be in body coordinates.  An\n"
"        arrow head pointing at (X,Y) is put in the\n"
"        middle of this line.\n"
"\n"
