...
{\tt .../AID/UID.info} exists for UID the user ID associated
with EMAIL.
\item Upon login, the {\tt .info} file name and modification
...
increasing its modification time.
\end{itemize}
