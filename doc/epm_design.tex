...
\item[\TT{admin/teams/AID/+rw+}:] See \pagref{TBD}
...
where
\begin{tabular}[t]{@{\hspace{0.2in}}lp{3.9in}}
BEGIN-TIME & request processing start time in 0.000001 seconds \\
END-TIME & request processing end time in 0.000001 seconds \\
SELF  & page name relative to W (EPM\_SELF)\\
AID   & account ID \\
UID   & user ID \\
\end{tabular}
