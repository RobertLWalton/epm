...
\\[1ex]
\begin{minipage}{5in}
These are global variables defined by index.php when it is
...
\TT{\$epm\_method}	& the request method, either 'GET' or 'POST' \\
...
\label{EPM_PAGE} \\
      The \$epm\_self value of the last 'GET'
      for the \$id\_type.
      Checked on 'POST's to be sure they target the
...
\label{EPM_ID_GEN} \\
      ...
      is encluded here as an optimization).
