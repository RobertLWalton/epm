...
for template files see \pagref{TEMPLATES} and \pagref{TEMPLATE.OPTN} \\{}
...
\TT{accounts/AID/PROBLEM/+work+/XXXX-PROBLEM.shout}  & create  & - & read & - \\
\TT{accounts/AID/PROBLEM/+work+/XXXX-PROBLEM.sherr}  & create  & - & - & - \\
\TT{accounts/AID/PROBLEM/+work+/XXXX-PROBLEM.*stat}  & create  & - & read & - \\
\end{tabular}
\\[2ex]
...
\begin{indpar}[0.2in]
\begin{tabular}[t]{lp{4.0in}}
\TT{EPM\_PROBLEM[problem]}\label{EPM_PROBLEM}
    & Problem Page Permanent State: \\
    & ~~ \TT{'ORDER'} {\tt =>} \\
    & ~~~~~~ currently selected problem list order \\
    & ~~~~~~ (see Help Page); one of: \\
    & ~~~~~~~~ \TT{'extension'} \\
    & ~~~~~~~~ \TT{'lexical'} \\
    & ~~~~~~~~ \TT{'recent'} 
\end{tabular}
