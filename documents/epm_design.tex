...
\FSTACK{projects}{/PROJECT/\\+priv+} & lines
	   ...
	   & \STACK{project\\problem\\run\\option\\manage\\show} \\ 
\hline
\FSTACK{projects}{/PROJECT/\\+blocked+} & lines
	   & \STACK{project\\block\\message \pagref{BLOCKED}}
	   & manage &
	   & \STACK{project\\problem\\run\\option\\list\\manage\\show} \\ 
\hline
...
\FSTACK{projects}{/PROJECT/\\PROBLEM/\\+priv+} & lines
	   ...
	   & \STACK{project\\problem\\run\\option\\manage\\show} \\ 
\hline
\FSTACK{projects}{/PROJECT/\\PROBLEM/\\+blocked+} & lines
	   & \STACK{problem\\block\\message \pagref{BLOCKED}}
	   & manage &
	   & \STACK{project\\problem\\run\\option\\manage\\show} \\ 
\hline
