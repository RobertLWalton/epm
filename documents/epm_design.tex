...
\TT{lists/AID:NAME} 	& create  & - & - & delete \\
\end{tabular}
...
if it does not exist.  When so created it contains the
...
\begin{tabular}{lllll}
\TT{accounts/AID/+lists+}    	& -  & - & read & - \\
\TT{accounts/AID/+lists+/+favorites}    	& -  & update & read & - \\
\TT{accounts/AID/+lists+/NAME.list}    	& -  & - & read & - \\
\TT{lists/AID:NAME} 	& -  & - & read & - \\
\end{tabular}
